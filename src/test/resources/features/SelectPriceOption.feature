# language: pt
@SelectPriceOption
Funcionalidade: Preencher aba Select Price Option
  Como usuário
  Eu devo selecionar a opção de preço


  Cenario: Deve selecionar o preço na aba Select Price Option
    ...
    Entao serei redirecionado para aba "Send Quote"
