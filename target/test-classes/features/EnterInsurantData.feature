# language: pt
@EnterInsurantData
Funcionalidade: Preencher formulário Enter Insurant Data
  Como usuário
  Eu devo preencher todos os campos do formulário
  Para pressionar o botão next

  Cenario: Deve preencher o formulário aba Enter Insurant Data
    ...
    Entao serei redirecionado para aba "Enter Product Data"
